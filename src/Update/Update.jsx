...
export default function Update() {
  ...
  return (
    ...
    <div className="bg-purple text-black card rounded-lg w-full max-w-md p- shadow-lg ">
      <h1 className="text-4xl font-semibold text-center lg:ml-40 mb-6 text-white">Update Movie</h1>
      <form onSubmit={updateMovie} className="space-y-4  bg-white/10 w-[600px] border-2 border-gray-500 p-3 shadow-2xl rounded-xl">
        {/* Image URL */}
