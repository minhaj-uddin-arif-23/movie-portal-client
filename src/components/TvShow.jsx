  ...
  return (
    <div>
     ...
     <saction className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 ">
        <img src={tv1} alt="" className='rounded-md' />
        {/* <img src={tv} alt=""  className='rounded-md' /> */}
        <img src={tv2} alt=""  className='rounded-md h-44' />
        <img src={tv3} alt=""  className='rounded-md h-44' />
        <img src={tv4} alt=""  className='rounded-md h-44' />
        <img src={tv5} alt=""  className='rounded-md h-44' />
        <img src={tv6} alt=""  className='rounded-md' />
        <img src={tv7} alt=""  className='rounded-md' />
        {/* another add image  */}
        <img src={a} alt="" className='rounded-md h-44' />
        <img src={b} alt="" className='rounded-md h-44' />
        <img src={c} alt="" className='rounded-md h-44' />
        <img src={d} alt="" className='rounded-md h-44' />
        <img src={e} alt="" className='rounded-md h-44' />
        <img src={f} alt="" className='rounded-md h-44' />
        <img src={g} alt="" className='rounded-md h-44 w-80' />
        {/* <img src={h} alt="" className='rounded-md h-44' /> */}
        <img src={j} alt="" className='rounded-md h-44 w-80' />
        <img src={m} alt="" className='rounded-md h-44' />
        <img src={n} alt="" className='rounded-md h-44' />
        <img src={o} alt="" className='rounded-md h-44' />
        <img src={z} alt="" className='rounded-md h-44' />
        {/* <img src={a} alt="" className='rounded-md h-44' /> */}
     </saction>
